...
export default function CompanyItem() {
  return (
    <div className='w-full py-[20px] px-[20px] flex gap-10 hover:bg-secondaryColor rounded-lg'>
      <img
      ...
      <div className='flex flex-col items-start justify-center gap-2 flex-1'>
        ...
        <div className='flex items-center justify-start gap-[2px]'>
          ...
          <span> - </span>
          <button className='text-sm text-blueColor font-semibold '>Change account</button>
        </div>
      </div>
    </div>
  )
