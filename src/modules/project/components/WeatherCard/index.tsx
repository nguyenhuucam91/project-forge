...
export default function WeatherCard() {
  return (
    <div className='flex justify-center w-full h-full text-gray-600'>
      <div className='card  w-full h-full border border-gray-100 bg-gray-100 transition-shadow test  shadow-lg hover:shadow-shadow-xl  text-purple-50 rounded-md'>
        <h2 className='text-md px-4 pt-3'>
          <div className='flex justify-between'>
            <div className='badge relative top-0'>
              <span className='mt-2 py-1 h-12px text-md font-semibold w-12px  rounded right-1 bottom-1 px-4 text-gray-600'>
                Laghouat
              </span>
            </div>
            <span className='text-lg font-bold text-gray-600'>6:13</span>
          </div>
        </h2>
        <div className='flex items-center justify-center'>
          <div className='flex justify-center items-center w-[100px] '>
            <svg height={20} width={20} viewBox='0 0 32 32' className='fill-current h-32 w-32 text-primary-800'>
              <path
        ...
        <div className='text-md  pb-4 px-4'>
          <div className='flex justify-between items-center'>
            <div className='space-y-2 text-gray-600'>
              <span className='flex space-x-2 items-center'>
                <svg height={20} width={20} viewBox='0 0 32 32' className='fill-primary-800'>
